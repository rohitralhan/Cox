...
public class IssueDO implements java.io.Serializable {
	...
	private com.cox.cox.IssueTypeDO type;
	...
	public com.cox.cox.IssueTypeDO getType() {
		return this.type;
	}

	public void setType(com.cox.cox.IssueTypeDO type) {
		this.type = type;
	}
